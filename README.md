...
- Preview: https://main--eds-storefront-jamsheed--JamsheedAliU.hlx.page/
- Live: https://main--eds-storefront-jamsheed--JamsheedAliU.hlx.live/
...
1. Open the `eds-storefront-jamsheed` directory in your favorite IDE and start coding :)
